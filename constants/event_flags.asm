...
; HMs (EVENT_GOT_ANTIGRAVITY is with the Johto itemballs)
	const EVENT_GOT_CHAINSAW
	const EVENT_GOT_AIRPLANE
	const EVENT_GOT_SURFBOARD
	const EVENT_GOT_MUSCLES
	const EVENT_GOT_FLASHLIGHT
	const EVENT_GOT_SEA_BRIDGE
	const_skip ; unused
; Rods
...
; Johto story events
	...
	const EVENT_GOT_COURIER
	const EVENT_GAVE_COURIER
